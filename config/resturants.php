...
$restaurants = [
    ...
    [
        'user_id' => 2,
        'name' => 'Ristorante Giapponese di Bruce',
    ...
    [
        'user_id' => 4,
        'name' => 'Ristorante Greco di Maria',
    ...
    [
        'user_id' => 5,
        'name' => 'Sapori d\'India Ristorante',
